...
export async function sendSingleEmail(input) {
    ...
    try {
        ...
        const mailOptions = {
            from: `'Meta Jobs' <${process.env.NODETAILER_EMAIL}>`,
            to: adminEmail,
            subject: input == null ? void 0 : input.subject,
            html: `
                <!DOCTYPE html>
                <html>
                                ...
                                <td style="padding-top: 40px;">
                                    <table width="100%">
                                        <tr>
                                            <td style="padding-top: 40px;">
                                                <p class="highlights">
                                                ${input == null ? void 0 : input.message}
                                                </p>
                                            </td>
                                        </tr>
                                    </table>
                                                    ...
                                                    <tr>
                                                        <td class="signature">
                                                            <table>
                                                                <tr>
                                                                    <td>
                                                                        <h3 style="margin:0 0 8px 0;">${input == null ? void 0 : input.name}</h3>
                                                                        <p style="margin: 0; font-size: 14px; font-weight: 400;">
                                                                            Mobile: ${input == null ? void 0 : input.mobile}
                                                                        </p>
                                                                        <p style="margin: 0; font-size: 14px; font-weight: 400;">
                                                                            Email: <span style="color: #1CAF57">${input == null ? void 0 : input.email}</span>
                                                                        </p>
                                                                    </td>
                                                                </tr>
                                                            </table>
